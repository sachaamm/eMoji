...
public class HairGenerator_1 : MonoBehaviour
    {


    //[ContextMenuItem("Randomize Name", "Name")]
    // public string Name;
    ...
    public Vector3 moveTop = new Vector3(0, 0, 0);
    ...
    void Start () {
        ...
        for(int i = 0; i < nbModule; i++)
        {
            ...
            curveEvolution[i] = Mathf.Sin( (i / (float)nbModule) * Mathf.PI );
    ...
    void resetLeft()
    {
        ...
        for (int i = 0; i < left.Length; i++)
        {
            ...
            //left[i] = saveLeft[i] - new Vector3(0,curveEvolution[i] * resetLeftValue,0);
            //right[i] = saveRight[i] - new Vector3(0, curveEvolution[i] * resetLeftValue, 0);
           // top[i] = saveTop[i]  -new Vector3(0, curveEvolution[i] * resetTopValue, 0);
            //bottom[i] = saveBottom[i] - new Vector3(0, curveEvolution[i] * resetTopValue, 0);
        ...
        setBottomVertices(bottom, new Vector3(0, 0, 0));
    ...
    void BuildTerrain()
    {
        ...
        for (int i = 0; i < nbModule * nbModule; i++)
        {
            ...
            vertices[i] = 
                ...
                v.y + addYCosine + addYCosine2 + circleY + moduloYVal + addDoubleSine + addThirdSine,
